...
<div class="graduate-section">
  ...
  <div class="card project-card">
    <div class="card-body">
      ...
      <div class="card-text">
        <p>基于<strong>全球疾病负担研究（GBD）数据库</strong>的数据新闻项目，通过数据分析和可视化揭示全球健康进步背景下年轻群体的异常死亡趋势。</p>
        <ul>
          ...
          <li><strong>成果产出</strong>：撰写<strong>4000字深度数据新闻稿件</strong>，制作成推文并将在校媒上进行发表，通过数据叙事揭示当下年轻人正面临的结构性社会压力</li>
  ...
  <div class="card project-card">
    <div class="card-body">
      ...
      <div class="card-text">
        <p>设计融合<strong>AI与旅游的综艺节目《跟着AI去旅游》</strong>，完成从创意提出到策划方案撰写。</p>
        <ul>
  ...
  <div class="card-body">
    ...
    <div class="card-text">
      ...
      <ul>
        ...
        <li>在心力衰竭死亡结果预测中最好的模型达到<strong>95%的准确率</strong></li>
      </ul>
    </div>
    <div class="project-meta">
